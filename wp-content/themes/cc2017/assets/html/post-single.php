<div id="blog-header" style="background: url(images/blog/medium/1.jpg); background-size: cover;">
    <div class="overlay"></div>
    <div class="single-post-title">
        <h1>Typography for web</h1>
        <p class="post-info">
            ...
            <div id="single-post">
                <div class="post">
                    ...
                    <div class="author-box row">
                        <div class="col-sm-2">
                            <img src="/wp-content/themes/cc2017/assets/img/blog/author.jpg" class="rounded-circle" alt="..." />
                        </div>
                        <div class="col-sm-10">
                    ...
                    <ul class="comments-list">
                        <li>
                            <div class="comment row">
                                <div class="col-sm-2">
                                    <img src="/wp-content/themes/cc2017/assets/img/blog/comment3.jpg" class="rounded-circle" alt="">
                                </div>
                                <div class="col-sm-10">
                            ...
                            <ul class="children">
                                <li>
                                    <div class="comment row">
                                        <div class="col-sm-2">
                                            <img src="/wp-content/themes/cc2017/assets/img/blog/comment1.jpg" class="rounded-circle" alt="">
                                        </div>
                                        <div class="col-sm-10">
                        ...
                        <li>
                            <div class="comment row">
                                <div class="col-sm-2">
                                    <img src="/wp-content/themes/cc2017/assets/img/blog/comment2.jpg" class="rounded-circle" alt="">
                                </div>
                                <div class="col-sm-10">
